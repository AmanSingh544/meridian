...
import type {
  ...
  DeliveryFeature, OnboardingProject,
...
// ─── 14. DELIVERY FEATURES ───────────────────────────────────────────────────

export const MOCK_DELIVERY_FEATURES: DeliveryFeature[] = [
  {
    id: 'DF-001',
    title: 'SLA Breach Alerts',
    description: 'Real-time notifications when tickets are approaching or have breached SLA thresholds.',
    status: 'RELEASED',
  ...
  {
    id: 'DF-002',
    title: 'AI Ticket Suggestions',
    description: 'AI-powered reply suggestions, auto-classification, and routing recommendations surfaced in the ticket workspace.',
    status: 'RELEASED',
    ...
    isPublic: true,
    category: 'AI',
    requestedByOrgIds: ['ORG-001', 'ORG-002', 'ORG-004'],
    hasVoted: false,
  ...
  {
    id: 'DF-003',
    title: 'Client Roadmap View',
    description: 'Public-facing product roadmap for client portal users to see upcoming features, vote on priorities, and submit feature requests.',
    status: 'IN_STAGING',
    assignee: 'Priya Sharma',
    assigneeId: 'USR-002',
    ...
    isPublic: true,
    category: 'Portal',
    requestedByOrgIds: ['ORG-002', 'ORG-003'],
    hasVoted: false,
  ...
  },
  {
    ...
    description: 'Structured phase-by-phase onboarding tracker visible to both internal team and client admin.',
    status: 'IN_QA',
    assignee: 'Alex Morgan',
    assigneeId: 'USR-001',
    eta: '2026-04-25T00:00:00Z',
    upvotes: 28,
    quarter: 'Q2 2026',
    isPublic: true,
    category: 'Onboarding',
    requestedByOrgIds: ['ORG-001'],
    hasVoted: false,
  ...
  {
    id: 'DF-005',
    title: 'Delivery Board Kanban',
    description: 'Internal Kanban board for tracking feature delivery with drag-and-drop and AI prioritisation.',
    status: 'IN_DEV',
    assignee: 'James Okafor',
    assigneeId: 'USR-003',
  ...
  },
  {
    ...
    description: 'Expanded analytics with trend charts, agent performance tables, SLA heatmaps, and exportable reports.',
    status: 'IN_DEV',
    assignee: 'Priya Sharma',
    assigneeId: 'USR-002',
    ...
    isPublic: true,
    category: 'Analytics',
    requestedByOrgIds: ['ORG-002', 'ORG-004'],
    hasVoted: false,
  ...
  },
  {
    ...
    description: 'Allow client admins to set their organisation logo, accent colour, and email template styles.',
    status: 'PLANNED',
    assignee: 'Alex Morgan',
    assigneeId: 'USR-001',
  ...
  },
  {
    ...
    description: 'TOTP-based 2FA for all internal users. Optional enforcement per organisation for client portal users.',
    status: 'PLANNED',
    assignee: 'James Okafor',
    assigneeId: 'USR-003',
    eta: '2026-06-30T00:00:00Z',
    upvotes: 45,
    quarter: 'Q2 2026',
    isPublic: true,
    category: 'Security',
    requestedByOrgIds: ['ORG-001', 'ORG-002', 'ORG-003', 'ORG-004'],
    hasVoted: false,
  ...
  },
  {
    ...
    description: 'Select multiple tickets and apply bulk status changes, reassignments, or priority updates.',
    status: 'BACKLOG',
    assignee: undefined,
  ...
  },
  {
    ...
    description: 'Outbound webhooks on ticket lifecycle events to integrate with Jira, Slack, or custom pipelines.',
    status: 'BACKLOG',
    assignee: undefined,
    assigneeId: undefined,
    eta: undefined,
    ...
    requestedByOrgIds: ['ORG-001', 'ORG-004'],
    hasVoted: false,
  ...
  {
    id: 'DF-011',
    title: 'AI Knowledge Base Auto-Draft',
    description: 'After a ticket is resolved, AI drafts a KB article from the conversation thread.',
    status: 'BACKLOG',
    assignee: undefined,
    assigneeId: undefined,
    eta: undefined,
  ...
  },
  {
    ...
    description: 'Native mobile apps for client portal users to submit tickets, view updates, and receive push notifications.',
    status: 'BACKLOG',
    assignee: undefined,
    assigneeId: undefined,
    eta: undefined,
...
// ─── 15. ONBOARDING PROJECTS ─────────────────────────────────────────────────

export const MOCK_ONBOARDING_PROJECTS: OnboardingProject[] = [
  {
    id: 'ONB-001',
    organizationId: 'ORG-001',
    ...
    phases: [
      {
        ...
        tasks: [
          ...
          { id: 'TSK-003', title: 'SSO configuration', description: 'SAML SSO integrated with Acme Corp identity provider.', owner: 'CLIENT', dueDate: '2026-03-18T00:00:00Z', status: 'DONE', completedAt: '2026-03-17T00:00:00Z' },
        ],
      },
      {
        id: 'PH-002',
        ...
        status: 'IN_PROGRESS',
        tasks: [
          { id: 'TSK-004', title: 'Legacy ticket export', description: 'Export all historical tickets from previous system as CSV.', owner: 'CLIENT', dueDate: '2026-04-05T00:00:00Z', status: 'DONE', completedAt: '2026-04-04T00:00:00Z' },
          { id: 'TSK-005', title: 'Data mapping & transformation', description: 'Map legacy fields to Meridian schema, handle custom fields.', owner: 'DELIVERY', dueDate: '2026-04-20T00:00:00Z', status: 'IN_PROGRESS', completedAt: undefined },
          { id: 'TSK-006', title: 'Dry-run import', description: 'Import to sandbox, validate counts and field accuracy.', owner: 'DELIVERY', dueDate: '2026-04-28T00:00:00Z', status: 'PENDING', completedAt: undefined },
          { id: 'TSK-007', title: 'Client sign-off on migrated data', description: 'Client reviews sample records and confirms accuracy.', owner: 'CLIENT', dueDate: '2026-05-02T00:00:00Z', status: 'PENDING', completedAt: undefined },
        ],
      },
      {
        id: 'PH-003',
        ...
        status: 'PENDING',
        tasks: [
          { id: 'TSK-008', title: 'UAT test plan review', description: 'Review and approve UAT scenarios covering core workflows.', owner: 'CLIENT', dueDate: '2026-05-05T00:00:00Z', status: 'PENDING', completedAt: undefined },
          { id: 'TSK-009', title: 'Training session - admin users', description: 'Live walkthrough for client admin users covering settings and reporting.', owner: 'DELIVERY', dueDate: '2026-05-12T00:00:00Z', status: 'PENDING', completedAt: undefined },
          { id: 'TSK-010', title: 'Training session - end users', description: 'Self-paced video and live Q&A for client end users.', owner: 'DELIVERY', dueDate: '2026-05-16T00:00:00Z', status: 'PENDING', completedAt: undefined },
        ],
      },
      {
        id: 'PH-004',
        ...
        status: 'PENDING',
        tasks: [
          { id: 'TSK-011', title: 'Final production import', description: 'Execute full data migration to production environment.', owner: 'DELIVERY', dueDate: '2026-05-26T00:00:00Z', status: 'PENDING', completedAt: undefined },
          { id: 'TSK-012', title: 'DNS cutover', description: 'Update DNS records to point to Meridian portal.', owner: 'CLIENT', dueDate: '2026-05-28T00:00:00Z', status: 'PENDING', completedAt: undefined },
          { id: 'TSK-013', title: 'Go-live sign-off', description: 'Formal client sign-off and hypercare period begins.', owner: 'CLIENT', dueDate: '2026-05-30T00:00:00Z', status: 'PENDING', completedAt: undefined },
        ],
      },
    ],
    created_at: '2026-03-01T00:00:00Z',
    ...
    phases: [
      {
        ...
        status: 'COMPLETED',
        tasks: [
          { id: 'TSK-014', title: 'Kick-off call completed', description: 'Initial discovery call with Beta Industries IT and ops teams.', owner: 'DELIVERY', dueDate: '2026-03-05T00:00:00Z', status: 'DONE', completedAt: '2026-03-05T00:00:00Z' },
          { id: 'TSK-015', title: 'Environment provisioned', description: 'Sandbox environment created, credentials delivered.', owner: 'DELIVERY', dueDate: '2026-03-08T00:00:00Z', status: 'DONE', completedAt: '2026-03-09T00:00:00Z' },
        ],
      },
      {
        id: 'PH-006',
        ...
        status: 'IN_PROGRESS',
        tasks: [
          { id: 'TSK-016', title: 'Legacy ticket export', description: 'Export tickets from Zendesk. Awaiting client IT approval.', owner: 'CLIENT', dueDate: '2026-03-25T00:00:00Z', status: 'DONE', completedAt: '2026-03-28T00:00:00Z' },
          { id: 'TSK-017', title: 'Data mapping & transformation', description: 'Complex custom field mapping - 3 rounds of revision needed.', owner: 'DELIVERY', dueDate: '2026-04-10T00:00:00Z', status: 'BLOCKED', completedAt: undefined },
          { id: 'TSK-018', title: 'Dry-run import', description: 'Blocked pending data mapping completion.', owner: 'DELIVERY', dueDate: '2026-04-18T00:00:00Z', status: 'BLOCKED', completedAt: undefined },
          { id: 'TSK-019', title: 'Client sign-off on migrated data', description: 'Pending dry-run completion.', owner: 'CLIENT', dueDate: '2026-04-25T00:00:00Z', status: 'PENDING', completedAt: undefined },
        ],
      },
      {
        id: 'PH-007',
        ...
        status: 'PENDING',
        tasks: [
          { id: 'TSK-020', title: 'UAT test plan review', description: '', owner: 'CLIENT', dueDate: '2026-04-28T00:00:00Z', status: 'PENDING', completedAt: undefined },
          { id: 'TSK-021', title: 'Training session - all users', description: '', owner: 'DELIVERY', dueDate: '2026-05-05T00:00:00Z', status: 'PENDING', completedAt: undefined },
        ],
      },
      {
        id: 'PH-008',
        ...
        status: 'PENDING',
        tasks: [
          { id: 'TSK-022', title: 'Final production import', description: '', owner: 'DELIVERY', dueDate: '2026-05-12T00:00:00Z', status: 'PENDING', completedAt: undefined },
          { id: 'TSK-023', title: 'Go-live sign-off', description: '', owner: 'CLIENT', dueDate: '2026-05-15T00:00:00Z', status: 'PENDING', completedAt: undefined },
        ],
      },
    ],
...
// ─── 16. DELIVERY AI RESPONSES ───────────────────────────────────────────────

export const MOCK_DELIVERY_RISKS: DeliveryRiskItem[] = [
  {
    featureId: 'DF-004',
    featureTitle: 'Onboarding Tracker',
    riskLevel: 'MEDIUM',
    reason: 'QA started 3 days late. 2 open bugs logged. ETA is Apr 25 with only 7 days of buffer.',
    daysUntilEta: 7,
    recommendation: 'Prioritise the 2 open QA bugs before merging any new work.',
  },
  {
    featureId: 'DF-005',
    featureTitle: 'Delivery Board Kanban',
    riskLevel: 'LOW',
    reason: 'Development is on track. No blocking issues. ETA May 10.',
    daysUntilEta: 22,
    recommendation: 'Maintain current velocity. Begin QA planning for late April.',
  },
  {
    featureId: 'DF-006',
    featureTitle: 'Advanced Analytics Dashboard',
    riskLevel: 'HIGH',
    reason: 'Scope expanded mid-sprint to include heatmaps. ETA pushed from May 10 to May 20. Two engineers on leave next week.',
    daysUntilEta: 32,
    recommendation: 'Descope heatmaps to a follow-up ticket or extend ETA by 1 week.',
  },
];

export const MOCK_DELIVERY_PRIORITISED: DeliveryPrioritisedFeature[] = [
  {
    featureId: 'DF-008',
    featureTitle: 'Two-Factor Authentication',
    suggestedStatus: 'IN_DEV',
    score: 94,
    reasoning: '45 upvotes across 4 orgs. Security compliance requirement flagged by 2 enterprise clients. Blocks contract renewal for ORG-001.',
  },
  {
    featureId: 'DF-010',
    featureTitle: 'Webhook Integrations',
    suggestedStatus: 'PLANNED',
    score: 78,
    reasoning: '31 upvotes from 2 enterprise orgs. Directly unblocks ORG-004 Jira integration work. Low development complexity.',
  },
  {
    featureId: 'DF-011',
    ...
    suggestedStatus: 'PLANNED',
    score: 61,
    reasoning: 'Moderate upvotes. High agent productivity impact. Aligns with Q3 AI investment theme.',
  },
];

export const MOCK_DELIVERY_DRAFT: DeliveryFeatureDraft = {
  description: 'This feature would allow agents to trigger an AI draft of a KB article after resolving a ticket. The draft would include problem summary, root cause, and resolution steps drawn from the ticket thread.',
  suggestedQuarter: 'Q3 2026',
  suggestedCategory: 'AI',
  suggestedAssigneeRole: 'Senior Engineer',
};

// ─── 17. ONBOARDING AI RESPONSES ─────────────────────────────────────────────

export const MOCK_ONBOARDING_HEALTH: Record<string, OnboardingHealthPrediction> = {
  'ONB-001': {
    onboardingId: 'ONB-001',
    health: 'ON_TRACK',
    confidence: 0.87,
    reason: 'All Phase 1 tasks completed on time. Data migration is progressing normally with no blockers.',
    predictedGoLive: '2026-05-30T00:00:00Z',
    daysVariance: 0,
  },
  'ONB-002': {
    ...
    health: 'AT_RISK',
    confidence: 0.79,
    reason: 'Data mapping task has been blocked for 8 days. If not resolved in 3 days the dry-run will slip past the UAT window, pushing go-live to June.',
    predictedGoLive: '2026-06-02T00:00:00Z',
    daysVariance: 18,
  },
};

export const MOCK_ONBOARDING_BLOCKERS: Record<string, OnboardingBlockerSummary> = {
  'ONB-001': {
    onboardingId: 'ONB-001',
    summary: 'No active blockers. Data migration is in progress and on schedule.',
    blockerCount: 0,
  ...
  'ONB-002': {
    ...
    blockerCount: 2,
    mostUrgent: 'Data mapping & transformation - blocked 8 days. Client IT contact has not responded to last 2 emails.',
  },
};

export const MOCK_ONBOARDING_NEXT_ACTIONS: Record<string, OnboardingNextAction> = {
  'ONB-001': {
    onboardingId: 'ONB-001',
    action: 'Chase client to begin dry-run sign-off review. Data mapping is finishing this week - schedule the review call now to avoid a gap.',
    priority: 'MEDIUM',
    ownedBy: 'DELIVERY',
  ...
  'ONB-002': {
    onboardingId: 'ONB-002',
    action: 'Escalate the data mapping blocker to client IT director. The 8-day delay has consumed all buffer time.',
    priority: 'HIGH',
    ownedBy: 'DELIVERY',
    draftMessage: 'Hi, I wanted to flag that the custom field mapping task has been blocked for 8 days. We have a go-live target of May 15 which is now at risk. Could you help get the right person engaged urgently? Thanks, James',
  },
};

// ── Escalation Queue ──────────────────────────────────────────────────────────

export const MOCK_ESCALATIONS: EscalatedTicket[] = [
  {
    ticketId: 'uuid-001', ticketNumber: 'TKT-004', title: 'Calendar Save Fails',
    clientName: 'Client 2', clientId: 'ORG-002', severity: TicketPriority.CRITICAL,
    escalatedBy: 'Nikita K.', escalatedByUserId: 'USR-004',
    reason: 'SLA breach imminent', timeInEscalationMinutes: 102,
    slaState: SLAState.AT_RISK, created_at: '2026-04-17T08:30:00Z',
  },
  {
    ticketId: 'uuid-002', ticketNumber: 'TKT-012', title: 'API timeout on bulk ops',
    clientName: 'Client 1', clientId: 'ORG-001', severity: TicketPriority.CRITICAL,
    escalatedBy: 'Ravi M.', escalatedByUserId: 'USR-003',
    reason: 'Customer impact on prod', timeInEscalationMinutes: 190,
    assignedTo: 'USR-002', assigneeName: 'Priya Sharma',
    slaState: SLAState.BREACHED, created_at: '2026-04-17T06:00:00Z',
  },
  {
    ticketId: 'uuid-003', ticketNumber: 'TKT-021', title: 'Data sync drops rows',
    clientName: 'Client 3', clientId: 'ORG-003', severity: TicketPriority.HIGH,
    escalatedBy: 'Priya Sharma', escalatedByUserId: 'USR-002',
    reason: 'Data integrity risk', timeInEscalationMinutes: 355,
    assignedTo: 'USR-003', assigneeName: 'James Okafor',
    slaState: SLAState.AT_RISK, created_at: '2026-04-17T04:05:00Z',
  },
  {
    ticketId: 'uuid-004', ticketNumber: 'TKT-026', title: 'Workflow freeze on approve',
    clientName: 'Client 2', clientId: 'ORG-002', severity: TicketPriority.HIGH,
    reason: 'Blocking client workflow', timeInEscalationMinutes: 440,
    slaState: SLAState.BREACHED, created_at: '2026-04-17T02:30:00Z',
  },
];
